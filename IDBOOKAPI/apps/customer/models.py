...
class Wallet(models.Model):
    ...
    company = models.ForeignKey(CompanyDetail, on_delete=models.DO_NOTHING,
                                null=True, related_name='wallet_company', blank=True)
    balance = models.DecimalField(max_digits=20, decimal_places=6, default=0, blank=True) #models.FloatField(default=0, blank=True, null=True)
