        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "user_account",
                    models.CharField(
                        help_text="Email or Mobile Number", max_length=100
                    ),
                ),
                (
                    "otp_for",
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=0,
                        help_text="Number of signup OTP verification attempts",
                    ),
                ),
                (
                    "last_attempt_time",
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True, help_text="Last OTP login attempt time", null=True
                    ),
                ),
                (
                    ...
                    models.DateTimeField(
                        blank=True,
                        help_text="Last password reset OTP attempt time",
                        null=True,
                    ),
                ),
                (
                    ...
                    models.DateTimeField(
                        blank=True,
                        help_text="Last signup OTP verification attempt time",
                        null=True,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Referral code associated with the user.",
                        max_length=120,
                    ),
                ),
                (
                    "referred_code",
                    models.CharField(
                        blank=True, help_text="Referred by user code.", max_length=120
                    ),
                ),
                (
                    "custom_id",
                    models.CharField(
                        blank=True,
                        db_index=True,
                        help_text="Custom ID for the user.",
                        max_length=15,
                    ),
                ),
                (
                    "category",
                    models.CharField(
                        blank=True, help_text="Category of the user.", max_length=20
                    ),
                ),
                (
                    "business_id",
                    models.BigIntegerField(
                        blank=True, help_text="Business detail id", null=True
                    ),
                ),
                (
                    "company_id",
                    models.BigIntegerField(
                        blank=True, help_text="company detail id", null=True
                    ),
                ),
                (
                    "first_booking",
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Whether the user's email address is verified.",
                    ),
                ),
                (
                    "mobile_verified",
                    models.BooleanField(
                        default=False,
                        help_text="Whether the user's mobile number is verified.",
                    ),
                ),
                (
                    "is_active",
                ...
                (
                    "default_group",
                    models.CharField(
                        help_text="Switched group", max_length=30, null=True
                    ),
                ),
                (
                    "created",
