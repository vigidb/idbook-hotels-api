    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "full_address",
                    models.CharField(help_text="Full address", max_length=100),
                ),
                ...
                (
                    "pin_code",
                    models.PositiveIntegerField(default=0, help_text="PIN code"),
                ),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "image",
                    models.ImageField(blank=True, null=True, upload_to="career/"),
                ),
                ("active", models.BooleanField(default=False)),
                ("created", models.DateTimeField(auto_now_add=True)),
                ("updated", models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "image",
                    models.ImageField(blank=True, null=True, upload_to="legality/"),
                ),
                ("active", models.BooleanField(default=False)),
                ("created", models.DateTimeField(auto_now_add=True)),
                ("updated", models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "image",
                    models.ImageField(
                        blank=True, null=True, upload_to="privacy-policy/"
                    ),
                ),
                ("active", models.BooleanField(default=False)),
                ("created", models.DateTimeField(auto_now_add=True)),
            ...
            fields=[
                ...
                (
                    ...
                    models.ImageField(
                        blank=True,
                        null=True,
                        upload_to="refund-and-cancellation-policy/",
                    ),
                ),
                ("active", models.BooleanField(default=False)),
                ("created", models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "image",
                    models.ImageField(
                        blank=True, null=True, upload_to="terms-and-conditions/"
                    ),
                ),
                ("active", models.BooleanField(default=False)),
                ("created", models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "mandate_tnx_id",
                    models.CharField(
                        blank=True, help_text="Mandate transaction id", max_length=100
                    ),
                ),
                (
                    "recrinit_tnx_id",
                ...
                (
                    "transaction_amount",
                    models.IntegerField(default=0, help_text="last transaction amount"),
                ),
                (
                    "mandate_status",
                    models.CharField(
                ...
                (
                    "cancel_tnx_id",
                    models.CharField(
                        blank=True, help_text="Cancel transaction id", max_length=100
                    ),
                ),
                ("created", models.DateTimeField(auto_now_add=True)),
                ("updated", models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="user_sub_recurtrans",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
                (
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="org_resources.amenitycategory",
                    ),
                ),
            ],
            options={
