...
from apps.org_resources.utils.db_utils import (
    ...
    fetch_rec_subscribers_to_notify,
    fetch_rec_subscribers_to_debit,
    fetch_subscription_for_mandate_check,
)
...
def subscription_payu_process(user_subscription_dict, params):
    ...
    if daily:
        ...
        si_details = {
            "billingAmount": subscription_amount,
            "billingCurrency": "INR",
    ...
    params.update(
        {"key": key, "udf1": "", "udf2": "", "udf3": "", "udf4": "", "udf5": ""}
    )
...
def subscription_phone_pe_process(
    ...
    payload = {
        ...
        "amount": subscription_amount,
        "paymentInstrument": {"type": "UPI_COLLECT", "vpa": upi},
    }
    ...
    for user_subscription in user_subscriptions:
        ...
        try:
            if payment_medium == "PayU":
                ...
                trans_dict["invoice_display_no"] = (
                    inv_display_no  # for transaction debit
                )
                ...
                if notify_status_code == 1:
                    ...
                    user_subscription.notification_id = notify_response.get(
                        "invoiceid", ""
                    )
            ...
            if payment_medium == "PayU":
                ...
                if debit_status_code == 1:
                    ...
                    if subscription_type == "Monthly":
                        ...
                        user_subscription.next_notify_date = (
