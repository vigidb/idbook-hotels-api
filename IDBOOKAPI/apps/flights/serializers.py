...
class FlightSearchSerializer(serializers.Serializer):
    ...
    origin = serializers.CharField(
        max_length=3, help_text="IATA code for origin airport"
    )
    destination = serializers.CharField(
        max_length=3, help_text="IATA code for destination airport"
    )
    departure_date = serializers.DateField(
        help_text="Departure date in YYYY-MM-DD format"
    )
    return_date = serializers.DateField(
        required=False, allow_null=True, help_text="Return date for round trip"
    )
    ...
    flight_class = serializers.ChoiceField(
        choices=[("E", "Economy"), ("P", "Premium"), ("B", "Business"), ("F", "First")],
        default="E",
    )
    ...
    sort_by = serializers.ChoiceField(
        choices=["price", "duration", "departure_time"], default="price"
    )
