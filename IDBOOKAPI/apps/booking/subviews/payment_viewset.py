...
from apps.booking.serializers import (
    PropertyPaymentBookingSerializer,
...
class PaymentPropertyViewSet(
    viewsets.ModelViewSet,
    PaymentPropertyFilterMixins,
    CommonDbMixins,
    ...
    def list(self, request, *args, **kwargs):
        ...
        pmedium_serializer = PaymentMediumSerializer(
            booking_payment_queryset, many=True
        )
        ...
        booking_payment_dict = self.queryset.values(
            ...
            "final_amount",
            "total_payment_made",
            "hotel_booking__confirmed_checkin_time",
            "hotel_booking__confirmed_checkout_time",
            "booking_payment__merchant_transaction_id",
            "booking_payment__payment_type",
            "booking_payment__payment_medium",
            "booking_payment__amount",
        ...
        data = {
            "payment_aggregate": booking_payment_agg,
            "booking_payment_details": serializer.data,
        }
