...
class FlightBookingFlowTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.wallet = CustomerWallet.objects.create(
            user=self.user, balance=Decimal("5000.00"), bonus_balance=Decimal("500.00")
        )
    ...
    def test_01_flight_search(self):
        ...
        with patch(
            "apps.booking.utils.flight_search_utils.AirIQFlightSearchService"
        ) as mock_service:
    ...
    def test_02_create_hold_booking(self):
        ...
        with patch(
            "apps.booking.utils.flight_booking_utils.AirIQFlightBookingService"
        ) as mock_service:
    ...
    def test_05_phonepe_payment_initiation(self):
        ...
        with patch(
            "apps.booking.utils.flight_payment_utils.PhonePayMixin"
        ) as mock_phonepe:
    ...
    def test_08_flight_status_update(self):
        ...
        with patch(
            "apps.booking.utils.flight_status_utils.AirIQFlightStatusService"
        ) as mock_service:
    ...
    def test_10_process_refund(self):
        ...
        with patch(
            "apps.booking.utils.flight_refund_utils.RefundProcessor"
        ) as mock_processor:
            ...
            refund_data = {"refund_method": "WALLET"}
    ...
    def test_12_hold_booking_expiry(self):
        ...
        with patch("django.utils.timezone.now") as mock_now:
            ...
            )  # May need background task to update
    ...
    def test_14_insufficient_wallet_balance(self):
        ...
        payment_data = {"payment_method": "WALLET", "amount": str(booking.total_amount)}
...
class FlightBookingErrorHandlingTestCase(APITestCase):
    ...
    def test_unauthorized_booking_access(self):
        ...
        other_user = User.objects.create_user(
            phone="9876543212", email="other@example.com"
        )
