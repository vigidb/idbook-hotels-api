...
def default_hotel_policy_json():
    ...
    custom_policy = {
        "custom_policy": {"value": "", "setting": {"type": "TEXT", "required": False}}
    }

    meal_rack_prices = {
        "breakfast": {"value": 0, "setting": {"type": "NUMBER", "required": False}},
        "lunch": {"value": 0, "setting": {"type": "NUMBER", "required": False}},
        "dinner": {"value": 0, "setting": {"type": "NUMBER", "required": False}},
    }
