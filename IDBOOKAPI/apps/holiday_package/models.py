...
class TourPackage(models.Model):
    ...
    tour_duration = models.CharField(
        max_length=50, choices=TOUR_DURATION_CHOICES, default=1
    )
...
class Accommodation(models.Model):
    ...
    tour = models.ForeignKey(
        TourPackage, on_delete=models.DO_NOTHING, related_name="tour_accommodation"
    )
    room_type = models.ForeignKey(
        RoomType, on_delete=models.DO_NOTHING, related_name="room_type"
    )
    occupancy = models.ForeignKey(
        Occupancy, on_delete=models.DO_NOTHING, related_name="occupancy_detail"
    )
...
class InclusionExclusion(models.Model):
    ...
    status = models.CharField(
        max_length=50, choices=INCLUSION_EXCLUSION_CHOICES, default="INCLUSION"
    )
    tour = models.ForeignKey(
        TourPackage,
        on_delete=models.DO_NOTHING,
        related_name="tour_inclusion_and_exclusion",
    )
...
class Vehicle(models.Model):
    ...
    tour = models.ForeignKey(
        TourPackage, on_delete=models.DO_NOTHING, related_name="tour_vehicle"
    )
...
class DailyPlan(models.Model):
    ...
    tour = models.ForeignKey(
        TourPackage, on_delete=models.DO_NOTHING, related_name="tour_daily_plan"
    )
...
class CustomerTourEnquiry(models.Model):
    ...
    tour_duration = models.CharField(
        max_length=50, help_text="enter duration like 4N/5D"
    )
    date_of_journey = models.DateField()
    adults = models.PositiveSmallIntegerField(default=1)
