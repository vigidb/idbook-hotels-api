...
router.register(
    "tour-accommodations", AccommodationViewSet, basename="tour_accommodations"
)
router.register(
    "tour-inclusions-exclusions",
    InclusionExclusionViewSet,
    basename="tour_inclusions-exclusions",
)
...
router.register(
    "tour-bank-details", TourBankDetailViewSet, basename="tour_bank_details"
)
router.register(
    "customer-tour-enquiries",
    CustomerTourEnquiryViewSet,
    basename="customer_tour_enquiries",
)
...
urlpatterns = [
    ...
    path(
        "tour-package-detail/<int:id>",
        TourPackageDetailView.as_view(),
        name="tour_package_detail_with_id",
    ),
]
