...
class PhonePayMixin:
    ...
    def get_encrypted_header_and_payload(
        self, payload, req_trigger=False, endpoint=None, callback_url=None
    ):
        ...
        verify_x_header = (
            self.encode_using_sha256(base64_request + endpoint + salt_key)
            + "###"
            + str(salt_index)
        )
        ...
        auth_header = {"Content-Type": "application/json", "X-VERIFY": verify_x_header}
    ...
    def set_recurring_init(self, payload):
        ...
        callback_url = (
            ...
            + "/api/v1/org-resources/user-subscription/recur-init/pe-callbackurl/"
        )
    ...
    def submit_auth_init(self, payload):
        ...
        callback_url = (
            settings.CALLBACK_URL
            + "/api/v1/org-resources/user-subscription/submit-auth-init/pe-callbackurl/"
        )  # "https://webhook.site/612a9220-e7f4-4c71-b44f-91d16f65773f"
