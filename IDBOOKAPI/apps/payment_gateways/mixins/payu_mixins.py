...
class PayUMixin:
    ...
    def recurring_payment_notification(self, var1):
        ...
        payload = {"key": key, "var1": var1, "command": command, "hash": hex_digest}
        headers = {
    ...
    def check_mandate(self, auth_id, request_id):
        ...
        payload = {"key": key, "command": command, "var1": var1, "hash": hex_digest}
    ...
    def cancel_subscription(self, authpayuid, requestid):
        ...
        var1 = {"authPayuId": authpayuid, "requestId": requestid}
        # convert dict to json
        var1 = json.dumps(var1)
    ...
    def subscribe_consent_netbnk_trans(self):
        ...
        surl = (
            ...
            + "api/v1/org-resources/user-subscription/payu-sucess/"
...
class PayUPayOutMixin:
    ...
    def initiate_transfer_api(self, payload):
        ...
        headers = {"pid": "245", "content-type": "application/json"}
